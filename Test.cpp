...
TEST_CASE("should not be working"){
    CHECK_THROWS(myNotebook.write(-1, 20, 3, Direction::Horizontal, "hey"));
    CHECK_THROWS(myNotebook.erase(11, -4, 33, Direction::Vertical, 2));
    CHECK_THROWS(myNotebook.read(1000, 1, -2, Direction::Vertical, 2));
    CHECK_THROWS(myNotebook.read(3000, 0, 23, Direction::Horizontal, 22));
